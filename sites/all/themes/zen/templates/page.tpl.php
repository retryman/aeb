...
<body  class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
	...
	<ul class="login-link-box">
		 <?php if(!$logged_in):?>		
		 <li><?php echo l('登录', 'user', array('query' => array('destination' => $_GET['q'])))?></li>
    ...
    <div id="header-region">
    	<?php print $header; ?>
    	<?php if($is_front):?>
    	<a href="/kidspassport/"><img class="banner" src="<?php echo $base_path.drupal_get_path('theme', 'zen').'/zen-internals/images/home-banner.gif';?>" /></a>    	
    	<?php endif;?>
    </div>
   	<?php endif;?>
