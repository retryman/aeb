...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
	<div class="block-inner">
	  <?php if ($title): ?>
	    <div class="title"><h2 class="title"><?php print $title; ?></h2></div>
	  <?php endif; ?>
	  
	  <div class="description">
	  <img src="<?php echo base_path().drupal_get_path('theme', 'zen').'/templates/images/user-experience-pic.png'?>" />
	  <div class="text">”赠人玫瑰，手留余香。“把您育儿过程中的经验、困惑、反思、建议都分享给大家吧，也许您也可以从大家的心得中，找到自己的收获，让我们共同成长!</div>
	  <div class="clear"></div>
	  </div>
