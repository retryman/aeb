...
<head>
  <title>分享 交流 爱--爱儿帮育儿俱乐部</title>
  <?php print $head; ?>
  <?php print $styles; ?>
  <?php if(arg(0) == 'node' && is_numeric(arg(1)) && !arg(2)):?>

    <script type="text/javascript" src="http://app.mapabc.com/apis?&t=flashmap&v=2.3.3&key=5074be584dd68e567e163ada0fc6aa3a593ad915e1431bb09c99d5081284a8ebc6c73cd76b54b296"></script>
...
<body  class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
	...
	<ul class="login-link-box">
		 <?php if(!$logged_in):?>
		 <li><?php echo l('登录', 'user', array('query' => array('destination' => 'user/cover/me')))?></li>
		 <li><?php echo l('注册', 'user/register');?></li>
		 <?php else:?>
		 <li><?php echo l('退出', 'logout');?></li>
		 <?php endif;?>
	 </ul>
    ...
    <div id="header-region">
    	<?php //print $header; ?>
    	<?php if($is_front):?>
    	<img class="banner" src="<?php echo $base_path.drupal_get_path('theme', 'zen').'/zen-internals/images/home-banner.png';?>" />    	
    	<?php endif;?>
    </div>
   	<?php endif;?>
