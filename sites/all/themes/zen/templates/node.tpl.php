...
?>
<?php if($teaser):?>
	<div id="node-<?php print $node->nid; ?>" class="<?php echo 'normal-nodeshow' ?> <?php print $classes; ?> clearfix">
	<table>
	<tr>
	<td  class="table-left">
		<div class="left">
				<a href="<?php echo base_path().'user/'.$node -> uid?>"><?php echo $image;?></a>
				<ul>
					<li>会员：<a href="<?php echo base_path().'user/'.$node -> uid?>"><?php echo $author->name;?></a></li>
					<li>
		    ...
		    <div class="meta">
		      <?php if ($display_submitted): ?>
		        <span class="submitted">
		          <?php
		            print '<span>发表于 '.date('Y-m-d h:s' ,$node -> created).'</span><span>回复：'.$node -> comment_count.'</span>';
		          ?>
		        </span>
		      <?php endif; ?>
...
<?php else:?>
	...
	<td valign="top">	
		<div class="right">
		  ...
		  <?php print $links; ?>
		  <a class="comment-link" href="#edit-comment">回复帖子</a>
		</div><!-- end right --> 
	</td>
	</tr>
	</table>	 
