	...
	if(isset($_COOKIE["trainingUserName"]))
	{
     ...
     <tr>
	   ...
	   if(isset($_COOKIE['trainingUserID']))
	   {
		    ...
		    echo "<tr><td colspan=\"6\"><div class=\"normal_text\">我报名的课程</div></td></tr>";
			   echo "<tr><td class=\"class_table_title\">课程</td><td class=\"class_table_title\">公司</td><td class=\"class_table_title\">日期</td><td class=\"class_table_title\">时间</td><td class=\"class_table_title\">讲师</td><td class=\"class_table_title\">地址</td></tr>";
			   echo "<tr class=\"table_tr\" height=\"1\"><td colspan=\"9\"></td></tr>";
			   select_class_by_user($_COOKIE['trainingUserID']);
			   echo "<tr><td colspan=\"6\"><div class=\"back_top\"><a href=\"classes.php\">返回上页</a></div></td></tr>";
			   echo "</table>";
	   }
	   else
	   {
