...
function checkPW()
{
	var p = document.getElementById("user_pass").value;
	var patrn_1=/^\S{6,18}$/;
	if (!patrn_1.exec(p)&&p!="")
  {
...
function checkEmail()
{
	var p = document.getElementById("user_email").value;
 ...
 <div>
	...
	if(isset($_COOKIE["trainingUserName"]))
	{
     ...
     <tr>
       ...
       <?php
	   /*if(isset($_COOKIE['trainingUserID']))
	   {
		   header("location: ./index.php");
	   }*/
       ?> 
       <ul class="reg_ul"><form action="tools/reg.php?other=aeb" method="post">
       <li>亲爱的同事，欢迎加入爱儿帮- IBM 父母学堂。请填写以下信息，邮箱最好使用个人常用邮箱，用于接收父母学堂"家庭教育"主题互动邮件和"趣玩派"家庭社交活动通知。</br></br>
身为父母是一项"活到老，学到老"的事业，希望您能以优异的成绩毕业！</br></br></li>
       <li><label for="user_name"><div class="red_text">用户名*</div></label><input type="text" name="user_name" id="user_name" onblur="javascript:checkInput();"/></li>
       <li><label for="user_pass"><div class="red_text">密码*</div></label><input type="password" name="user_pass" id="user_pass" onblur="javascript:checkInput();"/></li>
       <li><label for="user_repass"><div class="red_text">重复密码*</div></label><input type="password" name="user_repass" id="user_repass" onblur="javascript:checkInput();"/></li>
       <li><label for="user_email"><div class="red_text">电子邮件*</div></label><input type="text" name="user_email" id="user_email" onblur="javascript:checkInput();"/></li>
       <li><label for="user_P_name"><div class="red_text">员工姓名*</div></label><input type="text" name="user_P_name" id="user_P_name" onblur="javascript:checkInput();"/></li>
       <li><label for="user_phone"><div class="red_text">手机*</div></label><input type="text" name="user_phone" id="user_phone" onblur="javascript:checkInput();"/></li>
       <li><label for="user_company"><div class="red_text">公司名*</div></label><select name="user_company" id="user_company">
       <option value="IBM">IBM</option></select></li>
       <li><label for="user_baby_name"><div>宝宝姓名</div></label><input type="text" name="user_baby_name" id="user_baby_name" onblur="javascript:checkInput();"/></li>
       <li><label for="user_baby_birth"><div>宝宝生日</div></label><input name="user_baby_birth" type="text" id="user_baby_birth" onclick="new Calendar(1980, 2015).show(this);" size="10" maxlength="10" readonly="readonly" /></li>
       <li><label for="user_adress"><div>家庭地址</div></label><input type="text" name="user_adress" id="user_adress" onblur="javascript:checkInput();"/></li>
       <li><input type="submit" value="提交"  class="reg_button_2"/></li>
	   </form></ul></td><!-- InstanceEndEditable --></td></tr>
     </table>
