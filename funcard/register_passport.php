...
{
	var s = document.getElementById("passport").value;
	var patrn=/^[0-9]{6}$/;
  if (!patrn.exec(s)&&s!="")
  {
...
<table width="900" border="0" align="center" cellspacing="0" bgcolor="#FCF8EF">
	...
	if(isset($_COOKIE["couponUserName"]))
	{
     ...
     <table  width="900" border="0" align="center" cellspacing="0" bgcolor="#FCF8EF">
       ...
       <div class="PP_reg_mid">
       <ul class="reg_ul">
       <form action="tools/reg_PP.php" method="post">
        <li><label for="passport">护照号</label>     <input type="text" name="passport" id="passport" onblur="javascript:checkInput();"/></li>
       <li><input type="image" src="sitePIC/button/button_active.png" value=""  name="OK" id="active_button"/><div class="reset_button"><a href="index.php"><img src="sitePIC/button/button_back.png" class="mouse_over"/></a></div></li>
       </form>
       <?php
       if(isset($_COOKIE["couponUserName"]))
	{
