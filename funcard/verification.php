...
<table width="900" border="0" align="center" cellspacing="0" bgcolor="#FCF8EF">
	...
	if(isset($_COOKIE["couponUserName"]))
	{
     ...
     <table  width="900" border="0" align="center" cellspacing="0" bgcolor="#FCF8EF">
	   ...
	   else if($_COOKIE['couponUserName'] != 'aeb_eryi')
		   	{
		  		$url = "./index.php"; 
				echo "<script language='javascript' type='text/javascript'>"; 
				echo "window.location.href='$url'"; 
       ...
       中国儿童剧场\假日经典小剧场爱儿帮FUN卡优惠<br/>
请输入FUN卡卡号和会员手机号码验证优惠有效<br/><br/>
       </div>
       <a href="shopping.php">查看统计结果</a>
       <div class="verifi_alert">
       <form action="tools/verifi.php" method="post">
       <label for="card_ID">FUN 卡卡号</label><input type="text" name="card_ID" />
       <label for="phone">手机号码</label><input type="text" name="phone" />
       <input type="submit" value="查询" />
       </form>
       </div>
       <?php
	   if(!isset($_COOKIE['couponUserName']) && $_COOKIE['couponUserName'] != "aeb_eryi")
	   {
		  	$url = "./index.php"; 
			echo "<script language='javascript' type='text/javascript'>"; 
			echo "window.location.href='$url'"; 
       ...
       if(isset($_SESSION['result']))
       {
       		if($_SESSION['result'] == 1)
            {
				$card_id = $_SESSION['card_id'];
       			echo "<div class=\"verifi_alert\">该用户为FUN卡用户<br/>确认消费？</div>";
				echo "<div class=\"verifi_alert\"><form action=\"tools/confirm.php\" method=\"post\">
       <label for=\"card_id\">卡号</label><input type=\"text\" name=\"card_id\" value=\"".$card_id."\" readonly=\"readonly\"/><br/>
	   <label for=\"price\">本次消费金额</label><input type=\"text\" name=\"price\" value=\"\"/>
       ...
       <a href=\"\"><input type=\"button\" value=\"取消\" /></a>
            ...
            {
            	echo "<div class=\"verifi_alert\">FUN卡卡号或手机号码错误，请重新输入。</div>";
				unset($_SESSION['result']);
            }
       }
