...
<table width="900" border="0" align="center" cellspacing="0" bgcolor="#FCF8EF">
	...
	if(isset($_COOKIE["couponUserName"]))
	{
     ...
     <table  width="900" border="0" align="center" cellspacing="0" bgcolor="#FCF8EF">
       <td><!-- InstanceBeginEditable name="EditRegion3" --><table align="center" >
       <tr>
       <form action="tools/reg.php?other=aeb" method="post">
	...
	if(array_key_exists('name', $_POST))
	{
		...
		else
		{
			...
			{
				echo '注册失败，也许您的用户名已被使用；或者您所填写的信息有误。<br/>';
    ...
    <tr>
    <td>
    <label for="name">爱儿帮用户名</label></td><td><input type="text" name="name" id="name" />
    </td>
    </tr>
    <tr>
    <td>
<label for="pass">爱儿帮密码</label></td><td><input type="password" name="pass" id="pass" />
    </td>
    </tr>
    <tr><td></td><td>
