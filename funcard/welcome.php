...
<tr valign="top">
<td >
<img src="sitePIC/card_1_front_4.png" width="600"/>
</td>
<td width="200">
<?php
	...
	{
	$cid = find_card_id_by_uid($_COOKIE["couponUserID"]);
	$void_date = find_card_date_by_uid($_COOKIE["couponUserID"]);
	echo '<br/>';
	echo '欢迎您注册，您的卡号是：'.$cid.'<br/><br/>';
	echo '您的卡片有效期截止到：'.$void_date.'年/月/日<br/><br/>';
	}
?>
</td>
<tr>
<td colspan="2" align="center"><a href="coupon.php"><img src="sitePIC/complete.jpg" border="0" /></a>
</td>
</tr>
