<?php ob_start();?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Frameset//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd">
...
<table width="900" border="0" align="center" cellspacing="0" bgcolor="#FCF8EF">
	...
	if(isset($_COOKIE["couponUserName"]))
	{
        ...
        echo ', <a href="/funcard/mypage.php">我的页面</a>&nbsp;&nbsp;&nbsp;<a href=/funcard/tools/logout.php>登出</a>';
	}
     ?>
     </td>
     </tr>
     ...
     <table  width="900" border="0" align="center" cellspacing="0" bgcolor="#FCF8EF">
       ...
       ?>
       <ul class="merchant_login">
       <div class="normal_text">商户请输入用户名登录</div>
       <form action="tools/login.php" method="post">
       <li><label for="username"><div>商户用户名</div></label><input type="text" name="name" /></li>
       <li><label for="password"><div>密码</div></label><input type="password" name="password" /></li>
