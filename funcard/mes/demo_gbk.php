 ...
 * 序列号,请通过亿美销售人员获取
 */
$serialNumber = '3SDK-DJL-0130-MFQUP';
...
echo 'login is:'.$client->login().'<br>';
echo 'key is '.$client->getSessionKey().'<br>';
//echo 'message'.$result = $client->sendSMS(array('13426122199'),"test2测试");
echo 'logout is:'.$client->logout().'<br>';
